...
static bool waitFriends(int id)
{
    ...
    //if table is not complete clientState = WAIT_FOR_FRIENDS
...
static void waitAndPay (int id)
{
    ...
    //increment flag tableFinnishEat
